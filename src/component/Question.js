    ...
    <div className='qustion'>
      ...
      <div className='qustion_box2'>
        <div className='qustion_contact_wrap'>
          ...
          <div className='qustion_contact'>
            <a href='https://www.instagram.com/churchbooklet.co.kr/' target='_blank'>
              <div className='qustion_contact_image'>
            ...
            <div className='qustion_contact_bar'></div>
            <div className='qustion_contact_notice'>
              위의 아이콘을 클릭하시거나 인스타그램에 <span className='qustion_span'>@churchbooklet.co.kr</span>를 검색하여 들어오시면 DM을 통해 문의가 가능해요.
            </div>
          </div>
          <div className='qustion_contact'>
            ...
            <div className='qustion_contact_bar'></div>
            <div className='qustion_contact_notice'>
              <span>네이버 톡톡</span>을 통해서도 문의가 가능해요. 이는 네이버에서 "간호대학생들"을 검색한 후에도 이용하실 수 있어요.
            </div>
          </div>
